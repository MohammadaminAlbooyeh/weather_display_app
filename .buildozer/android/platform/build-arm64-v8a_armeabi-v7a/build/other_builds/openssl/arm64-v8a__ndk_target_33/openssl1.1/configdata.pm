...
our %config = (
  ...
  CFLAGS => [ "-target aarch64-linux-android33 -fomit-frame-pointer -march=armv8-a -fPIC" ],
  CPPDEFINES => [ "__ANDROID_API__=33" ],
  CPPFLAGS => [ "-DANDROID -I/Users/amin/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/include -I/Users/amin/Desktop/MyProjects/Weather-Display-App/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/weatherdisplay/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/Users/amin/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang++ -target aarch64-linux-android33 -fomit-frame-pointer -march=armv8-a -fPIC",
  CXXFLAGS => [ "-target aarch64-linux-android33 -fomit-frame-pointer -march=armv8-a -fPIC" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)aarch64-linux-android33-clang",
  minor => "1.1",
  ...
  perl_version => "5.34.1",
  perlargv => [ "shared", "no-dso", "no-asm", "android-arm64", "-D__ANDROID_API__=33" ],
  perlenv => {
