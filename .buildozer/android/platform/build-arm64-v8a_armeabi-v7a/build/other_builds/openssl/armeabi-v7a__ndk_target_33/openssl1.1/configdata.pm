...
our %config = (
  ...
  CFLAGS => [ "-target armv7a-linux-androideabi33 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  CPPDEFINES => [ "__ANDROID_API__=33" ],
  CPPFLAGS => [ "-DANDROID -I/Users/amin/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/darwin-x86_64/sysroot/usr/include -I/Users/amin/Desktop/MyProjects/Weather-Display-App/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/weatherdisplay/armeabi-v7a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/Users/amin/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang++ -target armv7a-linux-androideabi33 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CXXFLAGS => [ "-target armv7a-linux-androideabi33 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)armv7a-linux-androideabi33-clang",
  minor => "1.1",
  ...
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/Users/amin/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/darwin-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
